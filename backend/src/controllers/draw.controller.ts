...
import type { SinglePlayerGuessRequestBody, SinglePlayerGuessResponseBody } from "../types/api.types.js";

export const guessSinglePlayerDrawing = async (
  req: Request<unknown, SinglePlayerGuessResponseBody, SinglePlayerGuessRequestBody>,
  res: Response<SinglePlayerGuessResponseBody>,
) => {
