import type { AgentRoleConfig, AgentRoleName } from "./agent-role.types.js";

const agentRoles: AgentRoleConfig[] = [
  {
    name: "primary",
  ...
  },
  {
    ...
    prompt: [
      ...
      '{"tasks":[{"taskId":"short-kebab-id","title":"short title","instruction":"clear worker instruction","role":"worker"}],"reason":"why these tasks help"}',
...
export const getAgentRoleList = (): AgentRoleConfig[] => agentRoles;

export const getAgentRoleByName = (name: AgentRoleName = "primary"): AgentRoleConfig | undefined =>
  agentRoles.find((role) => role.name === name);
