...
export class OpenAiProvider implements LlmProvider {
  async getJsonResponse(messages: AgentMessage[], signal?: AbortSignal): Promise<unknown> {
    if (!llmConfig.apiKey) {
  ...
  async getAgentDecision(messages: AgentMessage[], signal?: AbortSignal): Promise<AgentDecision> {
